      ...
      <AnimatePresence initial={false} mode="wait">
        {open ? (
          <motion.div
            ...
            className="relative w-full overflow-hidden rounded-3xl border border-red-400/65 bg-[linear-gradient(180deg,rgba(28,10,16,0.99)_0%,rgba(12,8,12,0.99)_55%,rgba(8,8,10,0.99)_100%)] p-4 shadow-[0_0_44px_rgba(255,0,60,0.32)]"
          >
