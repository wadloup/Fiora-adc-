...
const comeHomeBackgroundSrc = "/backgrounds/come-home-wallpaper.mp4";
const comeHomePosterSrc = "/backgrounds/come-home-wallpaper.jpg";
      ...
      artwork: {
        ...
        filter:
          comeHomeBackgroundKind === "video"
            ? "contrast(1.02) saturate(0.98) brightness(0.88)"
